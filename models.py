...
class User(Base):
    ...
    recommand_job_1 = Column(String(50), nullable=False, default="")
    recommand_job_2 = Column(String(50), nullable=False, default="")
    recommand_job_3 = Column(String(50), nullable=False, default="")
